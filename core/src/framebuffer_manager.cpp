...
void FramebufferManager::on_awake() {
    ...
    m_framebuffers[(size_t)FrameBufferType::Transparency].create_transparent_per_pixel_linked_list(windowSize);
    ...
    //    m_framebuffers[(size_t)FrameBufferType::Transparency].create_transparent(windowSize); // for weighted blend
